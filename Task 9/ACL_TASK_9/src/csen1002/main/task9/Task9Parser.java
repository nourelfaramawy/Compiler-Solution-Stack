// Generated from C:/Users/xxnou/Desktop/CSEN 1002 Compilers Lab/ANTLR/ACL_TASK_9/grammar/Task9.g4 by ANTLR 4.13.1
...
public class Task9Parser extends Parser {
	...
	public static final int
		DIGIZERO=1, DIGIONE=2, HASHTAG=3;
	public static final int
	...
	public static class TContext extends ParserRuleContext {
		...
		public int m;
		public NContext n;
		public TerminalNode HASHTAG() { return getToken(Task9Parser.HASHTAG, 0); }
		public NContext n() {
	...
	public static class DContext extends ParserRuleContext {
		...
		public int check;
		public DContext d1;
		public TerminalNode DIGIZERO() { return getToken(Task9Parser.DIGIZERO, 0); }
		public TerminalNode DIGIONE() { return getToken(Task9Parser.DIGIONE, 0); }
		public DContext d() {
			return getRuleContext(DContext.class,0);
		}
	...
	public final DContext d(int r,int c) throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				((DContext)_localctx).l =  ((DContext)_localctx).d1.l; ((DContext)_localctx).check =  (1 - equals(_localctx.c, _localctx.r)) * ((DContext)_localctx).d1.check;
				}
				break;
			case 4:
				...
				setState(37);
				((DContext)_localctx).d1 = d(_localctx.r, _localctx.c+1);
				((DContext)_localctx).l =  ((DContext)_localctx).d1.l; ((DContext)_localctx).check =  equals(_localctx.c, _localctx.r) * ((DContext)_localctx).d1.check;
				}
				break;
			}
		}
